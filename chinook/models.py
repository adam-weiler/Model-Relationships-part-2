...
class Track(models.Model):
    ...
    genre = models.ForeignKey(Genre, on_delete=models.CASCADE, related_name="tracks_genre")
    media_type = models.ForeignKey(MediaType, on_delete=models.CASCADE, related_name="tracks_mediatype")
    name = models.CharField(max_length=255, null=False)
